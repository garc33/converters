...
public abstract class NumberObjectConverter<N extends Number> extends
        PatternObjectConverter<N> {
    ...
    protected final <T> T toNumber(Number value, Class<T> wantedType) throws ConverterException {
        ...
        if (wantedType.equals(Integer.class)) {
            ...
            if (longValue > Integer.MAX_VALUE) {
                throw new ConverterException("Value <" + value
                        + "> is too large for Integer");
            }

            if (longValue < Integer.MIN_VALUE) {
                throw new ConverterException("Value <" + value
                        + "> is too small for Integer");
            }
        ...
        if (wantedType.equals(Float.class)) {
            if (doubleValue > Float.MAX_VALUE) {
                throw new ConverterException("Value <" + value
                        + "> is too large for Float");
            }

            if (doubleValue < Float.MIN_VALUE) {
                throw new ConverterException("Value <" + value
                        + "> is too small for Float");
            }
        ...
        if (wantedType.equals(Double.class)) {
            if (doubleValue > Double.MAX_VALUE) {
                throw new ConverterException("Value <" + value
                        + "> is too large for Double");
            }

            if (doubleValue < Double.MIN_VALUE) {
                throw new ConverterException("Value <" + value
                        + "> is too small for Double");
            }

            return (T) new Double(doubleValue);
        }

        throw new ConverterException("Don't know how to convert <" + value
                + "> to <" + wantedType + ">");
    }
}
